...
export default function TampaConfidential() {
  ...
  return (
    <TampaLayout>
      {/* Hero Section with Synthwave Lightning Effect */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
        <div className="absolute inset-0 z-0">
          <img 
            src="/assets/tampa-synthwave-hero.png" 
            alt="Lightning Strike" 
            className="w-full h-full object-cover opacity-70 animate-pulse-slow"
          />
          <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-transparent to-black" />
          <div className="absolute inset-0 bg-[url('/assets/grid-pattern.svg')] opacity-30 mix-blend-overlay" />
        </div>
        ...
        <div className="container px-6 relative z-10">
          <div className="grid md:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <img 
                src="/assets/tampa-synthwave-engine.png" 
                alt="The Engine Core" 
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-black/80 backdrop-blur-md p-6 rounded-xl border border-white/10 shadow-[0_0_20px_rgba(192,38,211,0.2)]">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-cyan-400 text-sm">Ready for Deployment</p>
                  </div>
                  <Rocket className="text-fuchsia-500 w-8 h-8 drop-shadow-[0_0_10px_rgba(217,70,239,0.8)]" />
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-32 bg-zinc-950 relative">
        <div className="absolute inset-0 bg-[url('/assets/tampa-synthwave-bridge.png')] bg-cover bg-center opacity-20 fixed-bg mix-blend-screen" />
